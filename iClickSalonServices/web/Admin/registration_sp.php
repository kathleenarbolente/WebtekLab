                ...
                <div class="panel-body">  
                    <form role="form" method="post" action="registration_sp.php">  
                        <fieldset>  
							...
							<div class="form-group">
								<input class="form-control" placeholder="Bio" name="spbio" type="text" autofocus>
							</div>
							...
							<div class="form-group"> 
							  <label class="col-md-4 control-label" for="gender">Services</label>
								...
								<label class="radio-inline" for="gender-1">
								  <input type="radio" name="serviceOffer" id="gender-1" value="Facial">
								  Facial
								</label>
								<label class="radio-inline" for="gender-1">
								  <input type="radio" name="serviceOffer" id="gender-1" value="Hair">
								  Hair
								</label>
								<label class="radio-inline" for="gender-1">
								  <input type="radio" name="serviceOffer" id="gender-1" value="Makeup">
								  Makeup
								</label>
							</div>
...
{  
    ...
    $check_username_query="select * from request_sp WHERE username='$username'";  
	...
	echo "<script>window.open('sp_login.php','_self')</script>";  
	} else{
