                    ...
                    <form role="form" method="post" action="sp_login.php">  
                        <fieldset>  
                            ...
                            <div class="form-group">  
                                ...
                                <input class="btn btn-lg btn-success btn-block" type="submit" value="login" name="sp_login" >  
  
                            <!-- Change this to a button or input when using this as a form -->  
                          <!--  <a href="index.html" class="btn btn-lg btn-success btn-block">Login</a> -->  
                        </fieldset>  
                    </form> 
			<center><br><a href="admin_login.php">Log in as Admin</a></center>
				</div>  
            </div>  
        </div>  
    </div>  
...
{  
    ...
    $customers_query="select * from service_providers WHERE username='$username' AND password='$password'";	
    ...
    {  
               header( 'Location: /iClickServices/web/Customer Module/index.html' );   
